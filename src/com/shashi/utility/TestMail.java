...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "arbaz4sayyad@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to Vighnaharta Electronics</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with Vighnaharta Electronics.<br>"
					...
					+ "<span class='greenText'>VIGHNA500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
